...
26年5月份，上善若重新复活，花费了半个周末的时间完成了部分模组和 1.4.1 安卓端的旧版本触控。1.4.1 终于可以正式的出现在大众眼前了，可喜可贺（然后过了一周 Coop Deluxe Team 就把 1.5 发布出来了有点搞），但由于做的太赶，之前答应大聪明H（b站up主）内置新按键皮肤包和角色选择汉化没有内置在里面。  
### sanb
