...
<table>
  <tr>
    <td colspan="2"><center><img src="./coopdxcn.png"/><br><i>sm64coopdx 汉化版截图</i></center></td>
  </tr>
  <tr>
    <td>名称</td>
  ...
  <tr>
    <td>最新版本</td>
    <td><b>1.0 公测 (上游 Coopdx 1.5.1)</b></td>
  </tr>
  <tr>
    <td>适用平台</td>
    <td>Windows, Mac, Android, Linux, Unix-Like (未提供编译成品但可自行编译/Github Action)</td>
  </tr>
  <tr>
    <td>状态</td>
...
### sanb
26年7月底，上善若太懒了叫我合并 1.5.1 更新，于是 1.5.1 版本的合并和冲突小修复是本文档作者 (Toad114514) 合并上游更新的。哦对了上游换了一个新的 djui 字体渲染方式，可以直接换成新的渲染方式，也许有点优化了？  
弥补了先前 1.4.1 汉化未补上的内置 CS 汉化和大聪明H的触控材质 (仅安卓移植有) 
## 去哪里下载？
::: warning
为控制圈内人数结构和小鬼数量，您可以将该群号/群二维码/官网链接发给其他人让他们自行加入群内下载资源，但：  
**请不要将汉化版本以任何形式进行二次分发！请不要将汉化版本以任何形式进行二次分发！请不要将汉化版本以任何形式进行二次分发！**  

除开分享该群号/群二维码/官网链接的二次分发之外，**任何形式的二次传播方法都将禁止！包括但不限于：** 
 - 视频/直播中分享链接下载（包括上传到网盘并提供分享链接）
 - 将资源上传到 7723/虫虫助手 等任何第三方软件分享平台
 - 任何网盘的分享链接下载
 - 上传到其他群的群文件内
 - 任何形式的二次分发
    
发现违规者，一律删除二次分发资源+踢群处理！
:::
加入qq群获取资源：981281124
![qq群](./dxcnqq.png)
