...
sm64coopdx 是经一群国外大佬，经过前人的不断fork和不断改善之后的开源 Super Mario 64 现代平台移植版本，官方支持 Win x64, Mac Arm, Linux x64 和 Android armv8a。也允许自己编译支持到Win arm、树莓派、类Unix的支持。支持多人游戏（包括远程联机），较大的模组生态，详细设置和完整的 Lua API 支持，允许你在任何时间玩上你最喜欢的 sm64！  
